...
namespace SchoolManagement.Data.Migrations
{
    ...
    [Migration("20210801065613_Schoolmanagement00005")]
    partial class Schoolmanagement00005
    {
            ...
            modelBuilder.Entity("SchoolManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 600, DateTimeKind.Utc).AddTicks(7162),
                            ...
                            ProfileImage = (byte)0,
                            UpdatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 600, DateTimeKind.Utc).AddTicks(7541),
                            Username = "avdunusinghe@gmail.com"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 600, DateTimeKind.Utc).AddTicks(8883),
                            ...
                            Password = "HGnySkxIrdSxVCdICLWgVQxx",
                            ProfileImage = (byte)0,
                            UpdatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 600, DateTimeKind.Utc).AddTicks(8887),
            ...
            modelBuilder.Entity("SchoolManagement.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 619, DateTimeKind.Utc).AddTicks(3554),
                            IsActive = true,
                            UpdatedById = 1,
                            UpdatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 619, DateTimeKind.Utc).AddTicks(4067)
                        },
                        new
                        {
                            UserId = 2,
                            RoleId = 2,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 619, DateTimeKind.Utc).AddTicks(6016),
                            IsActive = true,
                            UpdatedById = 1,
                            UpdatedOn = new DateTime(2021, 8, 1, 6, 56, 11, 619, DateTimeKind.Utc).AddTicks(6019)
                        });
                });
