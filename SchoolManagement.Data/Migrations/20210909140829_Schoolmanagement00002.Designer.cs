...
namespace SchoolManagement.Data.Migrations
{
    ...
    [Migration("20210909140829_Schoolmanagement00002")]
            ...
            modelBuilder.Entity("SchoolManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 9, 9, 14, 8, 26, 996, DateTimeKind.Utc).AddTicks(3282),
                            ...
                            ProfileImage = (byte)0,
                            UpdatedOn = new DateTime(2021, 9, 9, 14, 8, 26, 996, DateTimeKind.Utc).AddTicks(3917),
                            Username = "avdunusinghe@gmail.com"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 9, 9, 14, 8, 26, 996, DateTimeKind.Utc).AddTicks(5949),
                            ...
                            Password = "HGnySkxIrdSxVCdICLWgVQxx",
                            ProfileImage = (byte)0,
                            UpdatedOn = new DateTime(2021, 9, 9, 14, 8, 26, 996, DateTimeKind.Utc).AddTicks(5955),
            ...
            modelBuilder.Entity("SchoolManagement.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2021, 9, 9, 14, 8, 27, 27, DateTimeKind.Utc).AddTicks(481),
                            IsActive = true,
                            UpdatedById = 1,
                            UpdatedOn = new DateTime(2021, 9, 9, 14, 8, 27, 27, DateTimeKind.Utc).AddTicks(1325)
                        },
                        new
                        {
                            UserId = 2,
                            RoleId = 2,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2021, 9, 9, 14, 8, 27, 27, DateTimeKind.Utc).AddTicks(4736),
                            IsActive = true,
                            UpdatedById = 1,
                            UpdatedOn = new DateTime(2021, 9, 9, 14, 8, 27, 27, DateTimeKind.Utc).AddTicks(4742)
                        });
                });
