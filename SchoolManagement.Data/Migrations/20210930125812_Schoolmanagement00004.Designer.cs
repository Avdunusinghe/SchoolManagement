...
namespace SchoolManagement.Data.Migrations
{
    ...
    [Migration("20210930125812_Schoolmanagement00004")]
    partial class Schoolmanagement00004
    {
            ...
            modelBuilder.Entity("SchoolManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 940, DateTimeKind.Utc).AddTicks(2024),
                            ...
                            ProfileImage = (byte)0,
                            UpdatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 940, DateTimeKind.Utc).AddTicks(2670),
                            Username = "avdunusinghe@gmail.com"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 940, DateTimeKind.Utc).AddTicks(4727),
                            ...
                            Password = "HGnySkxIrdSxVCdICLWgVQxx",
                            ProfileImage = (byte)0,
                            UpdatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 940, DateTimeKind.Utc).AddTicks(4732),
            ...
            modelBuilder.Entity("SchoolManagement.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 965, DateTimeKind.Utc).AddTicks(8872),
                            IsActive = true,
                            UpdatedById = 1,
                            UpdatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 965, DateTimeKind.Utc).AddTicks(9696)
                        },
                        new
                        {
                            UserId = 2,
                            RoleId = 2,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 966, DateTimeKind.Utc).AddTicks(3215),
                            IsActive = true,
                            UpdatedById = 1,
                            UpdatedOn = new DateTime(2021, 9, 30, 12, 58, 9, 966, DateTimeKind.Utc).AddTicks(3224)
                        });
                });
